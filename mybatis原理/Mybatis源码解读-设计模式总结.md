...
![pattern_builder](./_offline_resource/pattern_builder.png)



在Mybatis环境的初始化过程中，SqlSessionFactoryBuilder会调用XMLConfigBuilder读取所有的MybatisMapConfig.xml和所有的`*Mapper.xml`文件，构建Mybatis运行的核心对象Configuration对象，然后将该Configuration对象作为参数构建一个SqlSessionFactory对象。
...
![mybatis_builder_sqlSessionFactoryBuilder](./_offline_resource/mybatis_builder_sqlSessionFactoryBuilder.png)
...
![pattern_simple_factory](./_offline_resource/pattern_simple_factory.jpg)



qlSession可以认为是一个Mybatis工作的核心的接口，通过这个接口可以执行执行SQL语句、获取Mappers、管理事务。类似于连接MySQL的Connection对象。

![](./_offline_resource/mybatis_factory_sqlSessionFactory.png)
...
![pattern_singleton](./_offline_resource/pattern_singleton.jpg)
...
![pattern_Proxy](./_offline_resource/pattern_Proxy.jpg)





![pattern_Proxy_seq](./_offline_resource/pattern_Proxy_seq.jpg)
...
![pattern_composite2](./_offline_resource/pattern_composite2.png)
...
![mybatis_sqlNode_types](./_offline_resource/mybatis_sqlNode_types.png)
...
![pattern_templates](./_offline_resource/pattern_templates.png)

在Mybatis中，sqlSession的SQL执行，都是委托给Executor实现的，Executor包含以下结构：

![mybatis_executors](./_offline_resource/mybatis_executors.png)
...
![pattern_adapter](./_offline_resource/pattern_adapter.jpg)
...
![mybatis_logging_impls](./_offline_resource/mybatis_logging_impls.png)
...
![pattern_Decorator](./_offline_resource/pattern_Decorator.jpg)
...
![mybatis_decorators_cache](./_offline_resource/mybatis_decorators_cache.jpg)
...
![pattern_iterator](./_offline_resource/pattern_iterator.gif)



Java的Iterator就是迭代器模式的接口，只要实现了该接口，就相当于应用了迭代器模式：

![pattern_iterator_java_interface](./_offline_resource/pattern_iterator_java_interface.png)
